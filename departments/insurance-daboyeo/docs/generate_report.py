...
def page3_features(c):
    ...
    features_c = [
        ...
        '갱신 및 만기 알림',
        '어르신 친화 Q&A 챗봇 (11종 FAQ · 버튼식 / 에스컬레이션 자동)',
    ...
    features_a = [
        ...
        '상담 일정 관리',
        '설계사용 Q&A 챗봇 (10종 FAQ · 앱 사용법 자동 응답)',
...
def page4_synergy(c):
    ...
    effects_ag = [
        ...
        '고객 기본 질문은 Q&A 챗봇이 자동 응답 → 핵심 상담에만 집중',
        '설계사용 피드백 탭으로 업무 애로사항을 직접 시스템에 반영',
    ]
...
def page6_tech(c):
    ...
    status = [
        ...
        '[완료]  양쪽 앱 어르신 친화 Q&A 챗봇 (사용법 자동 응답)',
        '[완료]  양쪽 앱 고객센터·피드백 시스템 (AI 자동 분류)',
        '[완료]  마케팅 랜딩 페이지 (B2C+B2B 통합 · 실 스크린샷 10장)',
        '[완료]  Vercel API 서버 (텔레그램 프록시 · 사전예약 · 티켓 접수)',
        '[완료]  경쟁사 차별화 포지셔닝 (전 보험사 실시간 연동 카피)',
        '[진행]  CODEF API 정식 계약 협의 (2026-04-17 신청, 3영업일 예정)',
