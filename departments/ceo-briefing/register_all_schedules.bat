...
schtasks /Create /TN "KunStudio_Contests" /TR "python -X utf8 C:\Users\hdh02\Desktop\cheonmyeongdang\departments\intelligence\contests_watch.py" /SC DAILY /ST 09:05 /F

echo.
echo [6/7] Service health check every 5 minutes (KORLENS + 세금N혜택)
schtasks /Create /TN "KunStudio_HealthCheck" /TR "python -X utf8 C:\Users\hdh02\Desktop\cheonmyeongdang\departments\intelligence\health_check.py" /SC MINUTE /MO 5 /F

echo.
echo [7/7] Daily sales report at 10:00 + Security audit 03:00 + Intrusion watch 5min
schtasks /Create /TN "KunStudio_Sales" /TR "python -X utf8 C:\Users\hdh02\Desktop\cheonmyeongdang\departments\intelligence\sales_collector.py" /SC DAILY /ST 10:00 /F
schtasks /Create /TN "KunStudio_Security" /TR "python -X utf8 C:\Users\hdh02\Desktop\cheonmyeongdang\departments\security\security_audit.py" /SC DAILY /ST 03:00 /F
schtasks /Create /TN "KunStudio_Intrusion" /TR "python -X utf8 C:\Users\hdh02\Desktop\cheonmyeongdang\departments\security\intrusion_watch.py" /SC MINUTE /MO 5 /F

echo.
echo [+1] Unified media poster every 10 minutes (TG + X + IG + Kakao + LINE)
schtasks /Create /TN "KunStudio_MediaPoster" /TR "python -X utf8 C:\Users\hdh02\Desktop\cheonmyeongdang\departments\media\scheduler\unified_poster.py" /SC MINUTE /MO 10 /F

echo.
echo [+2] Daily auto promo AM 10:00 (weekday rotation — KORLENS·천명당·세금·보험)
schtasks /Create /TN "KunStudio_AutoPromo_AM" /TR "python -X utf8 C:\Users\hdh02\Desktop\cheonmyeongdang\departments\media\src\auto_promo.py daily" /SC DAILY /ST 10:00 /F

echo.
echo [+3] Daily auto promo PM 20:00 (저녁 재포스팅)
schtasks /Create /TN "KunStudio_AutoPromo_PM" /TR "python -X utf8 C:\Users\hdh02\Desktop\cheonmyeongdang\departments\media\src\auto_promo.py daily" /SC DAILY /ST 20:00 /F

echo.
echo [+4] Weekly summary Sunday PM 9:00
schtasks /Create /TN "KunStudio_WeeklySummary" /TR "python -X utf8 C:\Users\hdh02\Desktop\cheonmyeongdang\departments\media\src\auto_promo.py weekly" /SC WEEKLY /D SUN /ST 21:00 /F
