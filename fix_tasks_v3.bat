...
schtasks /Change /TN "KunStudio_Sales" /TR "\"%PY%\" -X utf8 \"C:\Users\hdh02\Desktop\cheonmyeongdang\departments\intelligence\sales_collector.py\"" > %TEMP%\fix_sales.log 2>&1
